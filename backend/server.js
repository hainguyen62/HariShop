...
import { autoSyncPendingGHNOrders, autoSyncPendingGHTKOrders, autoCancelUnpaidOnlineOrders } from './controllers/orderController.js'
...
async function start() {
  ...
  setTimeout(() => {
    ...
    setInterval(() => {
      ...
      autoCancelUnpaidOnlineOrders().catch((e) =>
        logger.error(`[Auto-cancel] Lỗi: ${e.message}`)
      )
