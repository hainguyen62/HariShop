          ...
          <Row className="g-4">
            ...
            <Col md={3}>
              ...
              <ul className="list-unstyled">
                ...
                <li><Link to="/bao-hanh" className="text-secondary text-decoration-none">Tra cứu bảo hành</Link></li>
                <li><Link to="/chinh-sach-bao-hanh" className="text-secondary text-decoration-none">Chính sách bảo hành</Link></li>
