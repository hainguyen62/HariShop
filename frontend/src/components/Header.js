        ...
        <Container>
          ...
          <Navbar.Collapse id='basic-navbar-nav' className="justify-content-center">
            ...
            <Nav className='ms-auto align-items-center nav-links-container'>
              ...
              {/* MỚI: link trực tiếp tới trang tra cứu bảo hành — hiện với
                  mọi người kể cả CHƯA đăng nhập, vì tính năng này thiết kế
                  cho cả khách vãng lai (public lookup, không cần tài khoản). */}
              <LinkContainer to='/bao-hanh'>
                <Nav.Link className="nav-link-pro px-3">
