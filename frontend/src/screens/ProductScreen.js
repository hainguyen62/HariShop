            ...
            <Col md={3}>
              <div style={{ ...cardStyle, border: '1px solid rgba(51,255,204,0.35)', position: 'sticky', top: '100px', padding: '1.2rem 1.5rem' }}>
                ...
                {product.colors && product.colors.length > 0 && (
                  ...
                  {/* MỚI: hiện số tháng bảo hành ngay trước nút mua — để
                      khách thấy trước khi quyết định mua, không phải đợi
                      sau khi đặt hàng mới biết. */}
                  <div style={{
                    display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                    background: 'rgba(76,219,128,0.08)', border: '1px solid rgba(76,219,128,0.25)',
                    borderRadius: '10px', padding: '10px 14px', marginBottom: '12px', fontSize: '13px',
                  }}>
                    <span style={{ color: '#4cdb80' }}>
                      <i className='fas fa-shield-alt me-2'></i>
                      Bảo hành chính hãng <strong>{product.warrantyMonths ?? 12} tháng</strong>
                    </span>
                    <Link to='/chinh-sach-bao-hanh' style={{ color: '#8a8fa3', textDecoration: 'underline', fontSize: '12px' }}>
                      Xem chính sách
                    </Link>
                  </div>
