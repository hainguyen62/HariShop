...
const ProfileScreen = ({ history }) => {
  ...
  // MỚI: số điện thoại cấp tài khoản
              ...
              <form onSubmit={submitHandler} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  <label style={labelStyle}>
                    Số điện thoại{' '}
                    <span style={{ color: '#6b7085', fontWeight: 400 }}>
                      (dùng làm gợi ý mặc định lúc đặt hàng nếu địa chỉ chưa có SĐT riêng)
                    </span>
                  </label>
                  <input type='tel' placeholder='VD: 0901234567' value={phone} onChange={(e) => setPhone(e.target.value)} style={inputStyle} />
                </div>
