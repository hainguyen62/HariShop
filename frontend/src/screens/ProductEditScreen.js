...
const ProductEditScreen = ({ match, history }) => {
  ...
  // MỚI: số tháng bảo hành riêng cho từng sản phẩm
  ...
  // MỚI: cần token để đính kèm header Authorization khi gọi /api/upload
  // (route này giờ yêu cầu đăng nhập admin, trước đây không cần).
      ...
      <FormContainer>
        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            {/* MỚI: số tháng bảo hành riêng cho sản phẩm — dùng cho tính
                năng tra cứu bảo hành công khai (không cần đăng nhập) */}
            <Form.Group controlId='warrantyMonths'>
              <Form.Label>
                Bảo hành (tháng){' '}
                <small style={{ color: '#94a3b8' }}>
                  (khớp quảng cáo trang chủ "12 đến 24 tháng")
                </small>
              </Form.Label>
              <Form.Control
                type='number'
